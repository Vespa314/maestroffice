...
export function UploadAttachmentModal({ isOpen, onClose, onAddAttachments }: UploadAttachmentModalProps) {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="上传附件" size="lg">
